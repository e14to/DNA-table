...
//     // Display result
//     document.getElementById("26").innerText = result26;
//     document.getElementById("15").innerText = result15;
//     document.getElementById("16").innerText = result16;
//     document.getElementById("17").innerText = result17;
//     document.getElementById("18").innerText = result18;
//     document.getElementById("25").innerText = result25;
//     document.getElementById("27").innerText = result27;
//     document.getElementById("28").innerText = result28;
//     document.getElementById("35").innerText = result35;
//     document.getElementById("36").innerText = result36;
//     document.getElementById("37").innerText = result37;
//     document.getElementById("38").innerText = result38;
//     document.getElementById("45").innerText = result45;
//     document.getElementById("46").innerText = result46;
//     document.getElementById("47").innerText = result47;
//     document.getElementById("48").innerText = result48;
   ...
   document.getElementById("error_output").innerText = val380_result


    if (typeof val380_result === "string") {
